...
export const personSchema = {
  ...
  "description": "Mentor tech especializado en desarrollo humano y liderazgo consciente. Acompaño a profesionales tech a encontrar propósito más allá del código.",
...
export const organizationSchema = {
  ...
  "@type": "Organization",
  "name": "HugoTech",
  "description": "Mentoring tech con alma. Sesiones 1-a-1 gratuitas y programas empresariales para transformación humana en tecnología.",
  "url": "https://hugotech.pe",
...
export const serviceSchema = {
  ...
  "description": "Sesiones gratuitas 1-a-1 de mentoring tech, coaching anti-burnout y programas empresariales de liderazgo ágil.",
  "provider": {
    "@type": "Person",
    "name": "Hugo Casanova"
  },
