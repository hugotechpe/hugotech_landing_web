          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card as="article" shadow="none" className="bg-[#FFE8DB] p-5 pb-0 pr-0 relative">
              <CardBody className="flex flex-col gap-3 text-customgray">
                ...
                <h4 className="mt-2 md:text-base font-semibold w-[85%]">Resultados que lograrás:</h4>
            ...
            <Card as="article" shadow="none" className="bg-[#E0F1DF] p-5 pb-0 pr-0 relative">
              <CardBody className="flex flex-col gap-3 text-customgray">
                ...
                <p className="text-base md:text-xl font-semibold my-4">
                  Equipos tech de alto rendimiento y cultura data-driven
                </p>
                <p className="text-customgray mr-5">
                ...
                <h4 className="mt-2 md:text-base font-semibold">Beneficios reales para tu empresa y tu equipo:</h4>
                <ul className="list-disc pl-10 space-y-2 text-customgray w-[80%]">
