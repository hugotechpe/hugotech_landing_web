          ...
          <div className="bg-white rounded-xl shadow-sm p-8 md:p-12 space-y-10">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                vinculado por estos Términos y Condiciones. Si no estás de
                acuerdo con alguna parte de estos términos, no debes utilizar
                nuestros servicios.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                ...
                <li>
                  Mantener la confidencialidad de tu cuenta si corresponde
                </li>
                <li>
            ...
            <section>
              ...
              <div className="space-y-3 text-gray-700 leading-relaxed">
                <p>
                  ...
                  mentoring y coaching se reservan a través de nuestro sistema
                  de calendario. Al reservar, te comprometes a asistir a la hora
                  acordada.
                </p>
                <p>
                ...
                <p>
                  ...
                  Cancelaciones tardías pueden resultar en cargos.
                </p>
                <p>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                Casanova / HugoTech y están protegidos por las leyes de
                propiedad intelectual. No está permitida su reproducción,
                distribución o uso comercial sin autorización expresa.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                coaching. Del mismo modo, esperamos que los clientes mantengan
                la confidencialidad de las metodologías y materiales
                compartidos.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                garantizamos resultados específicos y no nos hacemos
                responsables de decisiones tomadas por los clientes basadas en
                nuestras sesiones. Los resultados dependen del compromiso y
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                inmediatamente después de su publicación en este sitio web. Es
