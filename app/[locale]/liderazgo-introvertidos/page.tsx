            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <p className="text-sm text-white/80">
                    Primera sesión gratis • Diseña tu plan de liderazgo
                    auténtico
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                ...
                <p className="mt-6 text-white/80 italic">
                  No estás roto. Solo necesitas liderar desde tu estilo, no
                  contra él.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto max-w-screen-xl px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                El liderazgo tradicional fue diseñado por (y para)
                extrovertidos. Es hora de reescribir las reglas.
              </p>
            </div>
              ...
              <CardBody className="p-10 md:p-14">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  <div className="flex-shrink-0">
                    <div className="w-32 h-32 bg-gradient-to-br from-purple-500 via-indigo-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl">
