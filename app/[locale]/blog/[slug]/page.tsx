...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  return (
    <HomeLayout>
      {/* Tracker de views (invisible, solo tracking) */}
        ...
        <div className="mt-16 rounded-2xl bg-gradient-to-br from-primary to-primary-600 p-8 text-center text-white shadow-xl md:p-12">
          <div className="mx-auto max-w-2xl">
            ...
            <p className="mb-8 text-lg text-white/90">
              Primera sesión <strong>100% gratuita</strong>. Sin compromiso, sin
              presión. Solo una conversación honesta sobre tu carrera y cómo dar
              tu siguiente paso con propósito.
            </p>
