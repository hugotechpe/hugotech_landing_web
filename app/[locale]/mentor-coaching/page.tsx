...
export default function MentorCoachingPage() {
  const t = useTranslations("Sections.MentorCoaching");
  ...
  return (
    <main className="bg-white overflow-hidden">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary via-[#0d4746] to-[#083635]">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto max-w-1400 px-6">
          ...
          >
            ...
            <Card className="bg-gradient-to-br from-primary/5 to-brand/5 border-2 border-primary/20">
      ...
      {/* Testimonial Quote */}
      <section className="py-16 md:py-20 bg-gradient-to-br from-primary via-[#0d4746] to-[#083635] text-white">
        <div className="container mx-auto max-w-1400 px-6">
          <motion.div
