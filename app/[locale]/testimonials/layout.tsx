...
export const metadata: Metadata = {
  ...
  description: "Lee historias reales de profesionales tech que crecieron con coaching y mentoring. Transformaciones auténticas de personas que se atrevieron a mirarse dentro para crecer afuera.",
  keywords: [
  ...
  openGraph: {
    title: "Testimonios Reales: Historias de Transformación Tech | Hugo Casanova",
    description: "200+ personas que confiaron, crecieron y se transformaron. Historias reales de profesionales tech que encontraron claridad y propósito.",
    type: "website",
  },
};
