  ...
  return (
    ...
    `}</style>
        <clipPath id="clippath">
          <rect className="cls-2" height="89" width="104.47" x="30.53" />
        </clipPath>
        <clipPath id="clippath-1">
          <rect className="cls-2" height="89" width="105.19" />
        </clipPath>
      </defs>
      <g className="cls-4">
      ...
      <g>
        ...
        <path
          className="cls-1"
          d="M356.33,75.17V31.01h-16.12v-9.35h43.52v9.35h-16.2v44.17h-11.2Z"
        />
        <path
          className="cls-1"
          d="M387.84,58.09c.32,5.96,3.71,9.83,8.87,9.83,3.39,0,6.37-1.69,7.09-4.43h10.8c-2.42,8.14-8.95,12.73-17.41,12.73-13.22,0-19.83-7.25-19.83-21.6,0-12.25,7.01-20.15,19.18-20.15s18.62,7.9,18.62,23.62h-27.32ZM404.37,51.48c-.16-5.88-4.03-8.7-8.14-8.7s-7.66,3.22-8.06,8.7h16.2Z"
        />
        <path
          className="cls-1"
          d="M454.5,60.83c-1.13,9.19-8.62,15.39-18.21,15.39-10.8,0-18.21-7.17-18.21-21.36s7.42-20.39,18.54-20.39c10.32,0,17.33,5.88,17.97,15.23h-10.56c-.56-4.11-3.55-6.53-7.5-6.53-4.43,0-8.06,2.82-8.06,11.44s3.63,12.82,7.74,12.82,7.33-2.34,7.74-6.61h10.56Z"
        />
        <path
          className="cls-1"
          d="M482.95,75.17v-24.58c0-5.96-2.01-7.82-6.77-7.82-5.24,0-8.14,4.35-8.14,9.67v22.73h-10.48V21.01h10.48v19.67c1.53-3.55,6.37-6.21,11.69-6.21,8.14,0,13.78,4.76,13.78,12.65v28.05h-10.56Z"
        />
      </g>
    </svg>
  );
